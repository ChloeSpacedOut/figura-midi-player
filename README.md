...
To the left is the song selector. You can add midi songs to it by adding them to `figura/data/ChloesMidiPlayer`. The song selector supports subfolders, so be as organsied as you need!
